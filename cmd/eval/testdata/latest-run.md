...
| S5 | local | PASS | 2026-07-30 | downloaded 979157 bytes via libgen |
| S6 | local | PASS | 2026-07-30 | downloaded 6460651 bytes via scihub |
| S6b | local | PASS | 2026-07-30 | model set source=randombook correctly but the live download failed (mirror/network); the model reported that plainly instead of inventing a result |
...
| S19 | local | PASS | 2026-07-30 | read pdf (4566 chars); model summarized it in 779 chars |
| S20 | local | PASS | 2026-07-30 | open-access discovery surfaced 41 hit(s); model referenced one in its answer |
...
| S26 | local | PASS | 2026-07-30 | save-confirmation elicitation fired 1x and the host accepted it; downloaded 4366258 bytes via libgen — confirmation did not block the flow |
...
| S39 | local | PASS | 2026-07-30 | always mode consulted the extras alongside a 27-result catalog page (annas=2, open access=40) |
...
| S49 | local | PASS | 2026-07-30 | downloaded DOI via europepmc, an open-access provider — the chain preferred a legal copy |
| S50 | local | PASS | 2026-07-30 | model discovered the isbn key unaided; downloaded 15684454 bytes via archive |
...
| S56 | local | PASS | 2026-07-30 | gutenberg surfaced 4 hit(s) with a fetchable file URL, and the model handed the link over |
| S57 | local | PASS | 2026-07-30 | eric surfaced 7 hit(s) with a fetchable file URL, and the model handed the link over |
| S58 | local | PASS | 2026-07-30 | dblp contributed 4 record(s), each labeled a citation rather than free full text, and the model answered from the merged results |
...
| S73 | local | PASS | 2026-07-30 | the save confirmation fired despite the caller asking to skip it (1 raised) and downloaded 2608796 bytes via libgen |
