...
var scenariosES = map[string]string{
	...
	"S47": "**fatcat** — el mismo DOI de acceso abierto pedido «desde fatcat»; la API de Internet Archive Scholar es inalcanzable desde algunas redes, así que si el proveedor no responde se evalúa que el modelo lo diga",
