...
type ReadInput struct {
	...
	Source    string `json:"source,omitempty" jsonschema:"restrict the fetch to one source (libgen/randombook/annas for md5; unpaywall/europepmc/biorxiv/rfc/nist/dagstuhl/acl/zenodo/fatcat/core/oapen/scihub/scidb for doi; each of rfc, nist, dagstuhl, acl and zenodo serves only its own publisher's DOIs; unpaywall needs LIBGEN_MCP_UNPAYWALL_EMAIL and core needs LIBGEN_MCP_CORE_KEY)"`
