...
type ReadInput struct {
	...
	Source    string `json:"source,omitempty" jsonschema:"restrict the fetch to one source (libgen/randombook/annas for md5; unpaywall/europepmc/biorxiv/rfc/nist/fatcat/core/oapen/scihub/scidb for doi; rfc serves RFC DOIs and nist serves NIST publications; unpaywall needs LIBGEN_MCP_UNPAYWALL_EMAIL and core needs LIBGEN_MCP_CORE_KEY)"`
