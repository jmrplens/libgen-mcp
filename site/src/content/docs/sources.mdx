...
description: Per-source reference for the seventeen download sources — what each one reaches, how it resolves an identifier into a file, what it does not cover, and whether it needs a key.
