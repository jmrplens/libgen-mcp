...
| `fatcat`     | DOI       | Artículos de acceso abierto   | Busca el DOI en el catálogo de Internet Archive Scholar y devuelve una copia preservada alojada en Internet Archive, prefiriendo una copia directa de archive.org sobre una captura de Wayback. Sin clave.                                                                                                                               |
