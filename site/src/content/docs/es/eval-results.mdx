...
{/* prettier-ignore */}
La suite son **76 escenarios** (S1–S75 más la variante S6b). 10 de ellos ejercitan un servidor en modo remoto (`--http`); el resto lo ejecutan sobre stdio.
