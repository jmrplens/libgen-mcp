...
description: "Cómo se prueba libgen-mcp contra un LLM real: un arnés controlado conduce a Claude sobre MCP contra el sitio en vivo, evaluando selección de herramienta, argumentos, descargas, reintentos y progreso en 19 escenarios."
---
...
Diecinueve escenarios (S1–S18, más una variante S6b) cubren búsqueda, detalles,
...
| S16 | ✅ PASS   | resolvió una URL vía `libgen` sin descargar (`resolve_only`)                     |
| S17 | ✅ PASS   | modo remoto: el modelo obtuvo un enlace; el arnés descargó ~1,0 MB a disco local |
| S18 | ✅ PASS   | modo remoto: el modelo obtuvo un enlace; el arnés descargó ~6,5 MB a disco local |
