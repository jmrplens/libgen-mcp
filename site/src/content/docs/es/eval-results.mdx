...
{/* prettier-ignore */}
La tabla siguiente es un conjunto de ejecuciones en vivo entre el 2026-07-25 y el 2026-07-30 contra `claude-haiku-4-5-20251001` (API real de Anthropic, mirrors reales, descargas reales): **71 pasaron, 0 fallaron, 0 en SKIP** de los 71 medidos hasta ahora, incluidos los 10 que se ejecutan contra un servidor en modo remoto (`--http`). 5 escenarios de la lista anterior aún no tienen fila aquí: se añadieron después de la última ejecución en vivo, y un resultado solo se publica una vez medido. Cada fila lleva la fecha en que se midió por última vez: una ejecución parcial solo refresca los escenarios que ejecutó.
