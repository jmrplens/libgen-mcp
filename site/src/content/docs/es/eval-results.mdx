...
Un pleno merece leerse con cuidado más que celebrarse. Ha hecho falta quitar las
dos cosas que tapaban problemas: escenarios que se saltaban ante cualquier
...
muerto para comprobar que el calendario de reintentos devuelve un error accionable,
y otro restringe el despliegue al catálogo para comprobar que la restricción
aguanta.
