...
{/* prettier-ignore */}
La tabla siguiente es un conjunto de ejecuciones en vivo entre el 2026-08-08 y el 2026-08-09 contra `claude-haiku-4-5-20251001` (API real de Anthropic, mirrors reales, descargas reales): **77 pasaron, 4 fallaron, 0 en SKIP** de 81 — todos los escenarios, incluidos los 10 que se ejecutan contra un servidor en modo remoto (`--http`). Cada fila lleva la fecha en que se midió por última vez: una ejecución parcial solo refresca los escenarios que ejecutó.
