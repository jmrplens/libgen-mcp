...
Forty-two scenarios (S1–S41 plus the S6b variant) cover search, details, downloads, source selection, error
...
skipped** — every scenario, including the 10 that run against a server in remote
(`--http`) mode.
