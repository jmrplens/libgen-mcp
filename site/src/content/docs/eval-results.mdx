...
{/* prettier-ignore */}
The table below is a single live run of the full suite on 2026-08-09 against `claude-haiku-4-5-20251001` (real Anthropic API, real mirrors, real downloads): **81 passed, 0 failed, 0 skipped** out of 81 — every scenario, including the 10 that run against a server in remote (`--http`) mode.
