...
{/* prettier-ignore */}
The table below is a single live run of the full suite on 2026-07-30 against `claude-haiku-4-5-20251001` (real Anthropic API, real mirrors, real downloads): **70 passed, 4 failed, 2 skipped** out of 76 — every scenario, including the 10 that run against a server in remote (`--http`) mode.
