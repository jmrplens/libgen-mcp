...
| S20 | **Open-access discovery** — under-specified like S10–S13: the model must discover `extra_sources` itself and reference one of the federated arXiv/Crossref hits in its answer                                                                    |
