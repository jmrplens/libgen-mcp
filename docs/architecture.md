...
| `fatcat`     | DOI      | Open-access articles  | Looks the DOI up in Internet Archive Scholar's catalog and returns a preserved copy hosted on the Internet Archive, preferring a direct archive.org copy over a Wayback capture. Keyless.                                                                                                                         |
