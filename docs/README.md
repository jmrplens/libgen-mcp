...
| [HTTP server mode](http-server-mode.md) | Deploying the server over streamable HTTP: the declared host, trusted proxies and what identity a deployment has, the limits, TLS, drain and probes. |
