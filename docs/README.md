...
| [Download sources](sources.md)          | Per-source reference for the nineteen download sources: corpus, resolve mechanics, measured traps, keys, and crawl-rule constraints.     |
