...
[dblp](https://dblp.org/), [PubMed](https://pubmed.ncbi.nlm.nih.gov/), and
...
`origin: "annas"`); arXiv, Crossref, OpenLibrary, dblp, PubMed, and ERIC hits appear in a
separate `open_access` field alongside `results`.
