...
| `source`       | string | no       | Restrict the download to one source: `libgen`/`randombook`/`annas` (books) or `unpaywall`/`scihub`/`scidb` (articles). Omit to try all with failover.                                                                                                                                                                                |
